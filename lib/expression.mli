...
(**
	Instanciate a new expression representing the sum of two expressions
	It's abble detects some spetial cases like 0 + x = x or x + x = 2 * x
...
(**
	Instanciate a new expression representing the substraction of two expressions
	It's abble detects some spetial cases like 0 - x = -x or x - x = 0
...
(**
	Instanciate a new expression representing the multiplication of two expressions
	It's abble detects some spetial cases like 0 * x = 0 or x * x = x^2
...
val neg : expr -> expr
(**
	Instanciate a new expression representing the negation of the given expression
...
(**
	Instanciate a new expression representing the power of two expressions
	It's abble detects some spetial cases like x^0 = 1 or x^1 = x
...
(**
	Compute the derivate of the given expression with respect to the given variable
